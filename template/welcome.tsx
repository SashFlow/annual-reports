...
export default function WelcomeTemplate({
  ...
  const previewText = `You're on the ${siteConfig.name} founding list — we'll be in touch soon.`;
        ...
        <Container style={container}>
            ...
            <Row>
              ...
              <Column>
                <Text style={headerWordmark}>
                  Annual Reports{" "}
                  <span style={{ color: emailBrand.lavender }}>AI</span>
                </Text>
          ...
          <Section style={card}>
            ...
            <Text style={paragraph}>
              You&apos;re on the founding list for {siteConfig.name} — an AI
              reporting workflow platform designed for annual, quarterly,
              monthly, and ESG reporting teams.
            </Text>
            ...
            <Section style={stepsBox}>
              <Text style={stepItem}>
                ...
                We review your assessment and prioritize teams whose reporting
                needs match our launch cohort.
              </Text>
              <Text style={stepItem}>
                <span style={stepBullet}>2</span>
                You&apos;ll hear from us when a founding-team spot opens with
                onboarding details and pricing.
              </Text>
              <Text style={stepItem}>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              ...
              reporting teams globally.
            </Text>
            <Text style={footerMuted}>
              Sent by{" "}
              <Link href={absoluteUrl("/")} style={footerLink}>
                {siteConfig.name}
              </Link>
              {" · "}
